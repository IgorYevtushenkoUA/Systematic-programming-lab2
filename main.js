...
console.log(expressionCalculator(' sin ( 90 ) '));
console.log(expressionCalculator('2 * 3'));
console.log(expressionCalculator(' 60 + 30 / 2 - 85 '));
console.log(expressionCalculator('( ( 1 + 2 * 3'));
console.log(expressionCalculator(' 85 * 2 / (  88 / 11 - 18 * 1 ) - 61 ')); // -78
console.log(expressionCalculator('99 - 78 * (  (  (  63 + 52 / 67 + 26 / 29  ) + 94 + (  68 - 11 / 1 * 88  ) + 49  ) / 69 * 15 * 8  ) - 1 ')); //94013.7072
